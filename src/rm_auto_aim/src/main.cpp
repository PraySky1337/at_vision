...
int main(int argc, char* argv[]) {
    ...
    auto detector = std::make_shared<rm_auto_aim::ArmorDetectorNode>("armor_detector", "");
    auto tracker  = std::make_shared<rm_auto_aim::ArmorTrackerNode>(
        detector.get(), "armor_tracker", "");
    auto usb_driver = std::make_shared<usb_driver::UsbDriverNode>("usb_driver", "");
    auto trajectory = std::make_shared<trajectory::TrajectoryNode>("trajectory", "");
